...
public class ScanGeolocationJob extends Job {
    public static final String TAG = "RecordLocationJob";
    ...
    protected Result onRunJob(@NonNull final Params params) {
        ...
        ScanActivityIntentService.startActionRecordLocation(getContext());
    ...
    public static int schedule() {
        ...
        long interval = TimeUnit.MINUTES.toMillis(20); // every 20 min
        long flex = TimeUnit.MINUTES.toMillis(5); // -+5 min to run
