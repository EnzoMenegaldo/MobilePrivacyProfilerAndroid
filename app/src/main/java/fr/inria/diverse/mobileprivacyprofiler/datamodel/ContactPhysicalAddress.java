...
(currently only a big string, may need to be changed to detailed fields) */ 
	...
	public ContactPhysicalAddress(java.lang.String address, java.lang.String role, java.lang.String userId) {
		super();
	...
	public Contact getContact() {
		...
		if(_contextDB==null && this.contact == null){
			log.warn("ContactPhysicalAddress may not be properly refreshed from DB (android_id="+android_id+")");
		}
		return this.contact;
	}
	@JsonProperty
