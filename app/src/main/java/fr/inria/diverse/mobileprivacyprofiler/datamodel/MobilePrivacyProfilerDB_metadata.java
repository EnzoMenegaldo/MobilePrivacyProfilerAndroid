...
public class MobilePrivacyProfilerDB_metadata {
	...
	public static final String XML_ATT_LASTWIFISCAN = "lastWifiScan";
	...
	@DatabaseField
	protected java.util.Date lastWifiScan;
	...
	public MobilePrivacyProfilerDB_metadata(java.util.Date lastTransmissionDate, java.util.Date lastScanInstalledApplications, java.util.Date lastScanAppUsage, java.util.Date lastSmsScan, java.util.Date lastCallScan, java.lang.String userId, java.util.Date lastContactScan, java.util.Date lastWifiScan) {
		super();
		...
		this.lastWifiScan = lastWifiScan;
	} 
	...
	public java.util.Date getLastWifiScan() {
		return this.lastWifiScan;
	}
	@JsonProperty
	public void setLastWifiScan(java.util.Date lastWifiScan) {
		this.lastWifiScan = lastWifiScan;
	}
	...
	public String toXML(String indent, MobilePrivacyProfilerDBHelper contextDB){
    	...
    	sb.append("\" ");
		sb.append(" ");
    	sb.append(XML_ATT_LASTWIFISCAN);
    	sb.append("=\"");
		sb.append(this.lastWifiScan);
    	sb.append("\" ");
    	sb.append(">");
