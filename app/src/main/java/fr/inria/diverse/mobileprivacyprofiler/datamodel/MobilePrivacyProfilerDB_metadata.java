...
public class MobilePrivacyProfilerDB_metadata {
	...
	public MobilePrivacyProfilerDB_metadata(java.util.Date lastTransmissionDate, java.util.Date lastScanInstalledApplications, java.util.Date lastScanAppUsage) {
		super();
