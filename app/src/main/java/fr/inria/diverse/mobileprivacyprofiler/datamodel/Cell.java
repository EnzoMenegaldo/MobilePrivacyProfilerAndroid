...
public class Cell {
	...
	public CdmaCellData getCdmaposition() {
		...
		if(_contextDB==null && this.cdmaposition == null){
			log.warn("Cell may not be properly refreshed from DB (android_id="+android_id+")");
		}
