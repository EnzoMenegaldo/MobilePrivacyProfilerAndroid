...
package fr.inria.diverse.mobileprivacyprofiler.services.PacketSnifferService.util;
...
public class PacketUtil {
	 ...
	 */
	public static String intToHostname(int addressInt)
	{
		String ipAddress = intToIPAddress(addressInt);
		try {
